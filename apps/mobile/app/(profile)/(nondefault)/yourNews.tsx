...
export default function YourNews() {
    ...
    const [userPublishedNews, setUserPublishedNews] = useState<any>([])
            ...
            <ScrollView className="gap-5 py-4">
                <View className='flex pt-2 pb-4 bg-atu-gold-vl'>
                    <View className="flex-row justify-between pl-3 pr-2">
                        <Text className='text-lg font-bold text-white '>Your Published News</Text>
                        <Link href="/addNews" asChild>
                            <Pressable>
